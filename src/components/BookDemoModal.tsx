...
export default function BookDemoModal({ isOpen, onClose }: BookDemoModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Trigger Firebase Email Extension by writing to "mail" collection
      const htmlContent = `
        <!DOCTYPE html>
        <html>
        <head>
          ...
          <div class="container">
            ...
            <div class="content">
              <div class="detail-row">
                ...
                <p class="value">${formState.instituteName}</p>
              </div>
              <div class="detail-row">
                <span class="label">Contact Person</span>
                <p class="value">${formState.ownerName}</p>
              </div>
              <div class="detail-row">
                <span class="label">WhatsApp Number</span>
                <p class="value">${formState.whatsapp}</p>
              </div>
              <div class="detail-row">
                <span class="label">Category</span>
                <p class="value">${formState.category}</p>
              </div>
              <div class="detail-row">
                <span class="label">Active Students</span>
                <p class="value">${formState.students}</p>
              </div>
              ...
              <div class="detail-row">
                ...
                <div class="notes-box">
                  <p class="value">${formState.notes}</p>
                </div>
              </div>
              ` : ''}
            </div>
            <div class="footer">
              <p>This email was automatically generated from your FeeSync website form via Firebase Trigger Email.</p>
            </div>
          </div>
        </body>
        </html>
      ...
      await addDoc(collection(db, "mail"), {
        ...
        message: {
          subject: `🔥 New Demo Request: ${formState.instituteName}`,
          html: htmlContent,
        }
      });
